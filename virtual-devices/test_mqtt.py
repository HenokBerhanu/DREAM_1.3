...
def publish(topic, payload, label):
    ...
    print(f"[{label}] {topic}: {msg}", flush=True)
...
def test_bed_sensor():
    ...
    publish("devices/bed_sensor", payload, "Bed Sensor")
...
def test_ecg_monitor():
    ...
    publish("devices/ecg_monitor", payload, "ECG Monitor")
...
def test_infusion_pump():
    ...
    publish("devices/infusion_pump", payload, "Infusion Pump")
...
def test_ventilator():
    ...
    publish("devices/ventilator", payload, "Ventilator")
...
def test_wheelchair():
    ...
    publish("devices/wheelchair", payload, "Wheelchair")
...
def test_alert():
    ...
    publish("devices/ventilator", payload, "ALERT (ventilator)")
