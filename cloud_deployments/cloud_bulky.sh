...
##################################                                                                    ######################################
################################## The bleow line are suplementary if the above ones are not working  ######################################
##################################                                                                    ######################################
...
# Taken from the kubeedge repo
keadm join \
  --cloudcore-ipport="THE-EXPOSED-IP":10000 \
  --token=27a37ef16159f7d3be8fae95d588b79b3adaaf92727b72659eb89758c66ffda2.eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE1OTAyMTYwNzd9.JBj8LLYWXwbbvHKffJBpPd5CyxqapRQYDIXtFZErgYE \
  --kubeedge-version=v1.12.1
